...
use endpoints::{create::create, delete::delete, list::list, read::read, update::update};
...
async fn main() {
    ...
    let param_filter = warp::path!("task" / String).map(|id: String| parse_id(&id).unwrap());
